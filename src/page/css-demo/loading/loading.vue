<template>
  <div>
    <div class="box progress-1"></div>
    <div class="box progress-2"></div>
    <div class="box progress-3"></div>
    <div class="box progress-4"></div>
    <div class="box progress-5"></div>
    <div class="box progress-6"></div>
    <div class="box progress-7"></div>
    <div class="box progress-8"></div>
    <div class="box progress-9"></div>
