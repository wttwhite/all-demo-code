<template>
  <section class="w3l-workinghny-form">
    <div class="workinghny-form-grid">
      <div class="wrapper">
        <div class="logo">
          <h1><a class="brand-logo" href="index.html">工 作 登 录</a></h1>
        </div>
        <div class="workinghny-block-grid">
          <div class="workinghny-left-img align-end">
            <img
              src="../img-rotate-3d/img/1.jpg"
          ...
          <div class="form-right-inf">
            <div class="login-form-content">
              ...
              >
                ...
                <p class="already">如果你还没有账户 <a href="#">请注册</a></p>
              </form>
            </div>
          </div>
        </div>
    ...
    <div class="copyright text-center">
      <div class="wrapper">
        <p class="copy-footer-29">
          © 2022 工作登录页面 <a href="https://www.webqdkf.com">web前端开发</a>
        </p>
      </div>
    </div>
  </section>
